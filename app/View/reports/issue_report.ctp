...
-->
<h3><?php echo h(__('Tracker')); ?>&nbsp;&nbsp;<?php echo $this->Html->link($this->Html->image('zoom_in.png'), array($project['identifier'], '?' => 'detail=tracker'), null, null, false); ?></h3>
...
-->
<br />
<h3><?php echo h(__('Priority')); ?>&nbsp;&nbsp;<?php echo $this->Html->link($this->Html->image('zoom_in.png'), array($project['identifier'], '?' => 'detail=priority'), null, null, false); ?></h3>
...
-->
<h3><?php echo h(__('Assigned to')); ?>&nbsp;&nbsp;<?php echo $this->Html->link($this->Html->image('zoom_in.png'), array($project['identifier'], '?' => 'detail=assigned_to'), null, null, false); ?></h3>
...
-->
<h3><?php echo h(__('Author')); ?>&nbsp;&nbsp;<?php echo $this->Html->link($this->Html->image('zoom_in.png'), array($project['identifier'], '?' => 'detail=author'), null, null, false); ?></h3>
...
-->
<h3><?php echo h(__('Version')); ?>&nbsp;&nbsp;<?php echo $this->Html->link($this->Html->image('zoom_in.png'), array($project['identifier'], '?' => 'detail=version'), null, null, false); ?></h3>
...
<h3><?php echo h(__('Subproject')); ?>&nbsp;&nbsp;<?php echo $this->Html->link($this->Html->image('zoom_in.png'), array($project['identifier'], '?' => 'detail=subproject'), null, null, false); ?></h3>
...
-->
<h3><?php echo h(__('Category')); ?>&nbsp;&nbsp;<?php echo $this->Html->link($this->Html->image('zoom_in.png'), array($project['identifier'], '?' => 'detail=category'), null, null, false); ?></h3>
