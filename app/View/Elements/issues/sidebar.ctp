...
<?php echo $this->Html->link(__('Change log'), am(isset($main_project) && $main_project ? array('id' => $main_project['Project']['identifier']) : array(), array('controller' => 'projects', 'action' => 'changelog'))) ?><br />
<!--
