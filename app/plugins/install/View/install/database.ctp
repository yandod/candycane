<div class="install form">
    ...
    <?php
        ...
        echo $form->input('Install.database', array('label' => __('Exsisting database name'), 'value' => 'candycane'));
        echo $form->input('Install.prefix', array('label' => __('Prefix for table name.(if you need)'), 'value' => '', 'disabled' => 'disabled'));
        echo $form->end(__('Build database'));
    ?>
</div>