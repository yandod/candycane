...
<p><label><?php __('Display comments') ?></label><?php echo $form->select('UserPreference.pref.comments_sorting',aa('asc',__('In chronological order',true),'desc',__('In reverse chronological order',true)),null,null,false) ?></p>
</div>
<?php echo "</div>" ?>
<?php echo $form->end() ?>
