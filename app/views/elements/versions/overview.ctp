...
<?php if ($fixed_issue_count > 0): ?>
    ...
    <p class="progress-info">
        <?php echo $html->link($version['closed_issues_count'], array('issues/index?project_id='.$version['project_id'].'&status_id=c&fixed_version_id='.$version['id'].'&set_filter=1')) ?>
<?php /*
 ...
 */ ?>
        <?php echo $html->link($version['open_issues_count'], array('issues/index?project_id='.$version['project_id'].'&status_id=o&fixed_version_id='.$version['id'].'&set_filter=1')) ?>
