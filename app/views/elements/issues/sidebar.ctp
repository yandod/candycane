<h3><?php __('Issues') ?></h3>
<?php echo $html->link(__('View all issues', true), am(isset($project) && $project ? array('project_id' => $project['Project']['identifier']) : a(), array('controller' => 'issues', 'action' => 'index', '?set_filter=1'))) ?><br />
<!--<%= link_to l(:label_issue_view_all), { :controller => 'issues', :action => 'index', :project_id => @project, :set_filter => 1 } %><br />-->
<?php if (isset($project) && $project): ?>
<?php echo $html->link(__('Summary', true), am(isset($project) && $project ? array('id' => $project['Project']['identifier']) : a(), array('controller' => 'reports', 'action' => 'issue_report'))) ?><br />
<?php echo $html->link(__('Change log', true), am(isset($project) && $project ? array('id' => $project['Project']['identifier']) : a(), array('controller' => 'projects', 'action' => 'changelog'))) ?><br />
<!--
