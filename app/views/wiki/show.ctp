...
<?php if ($content['Content']['version'] !== $page['Content']['version']) : ?>
    <p>
    <?php if ($content['Content']['version'] > 1) { echo $html->link('&#171; ' . __('Previous', true), aa('controller', 'wiki', 'action', 'index', 'project_id', $project_id, 'wikipage', $page['Page']['title'], 'version', $content['Content']['version'] - 1), array(), false, false); echo " - "; } ?>
...
<span><?php echo $html->link('HTML', array('action' => 'index', 'project_id' => $project_id, 'wikipage' => $page['Page']['title'], '?export=html&version='. $content['Content']['version']), array('class' => 'html')) ?></span>
<span><?php echo $html->link('TXT', array('project_id' => $project_id, 'wikipage' => $page['Page']['title'], '?export=txt&version='. $content['Content']['version']), array('class' => 'text')) ?></span>
</p>
